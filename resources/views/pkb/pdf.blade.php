...
table.info td {
    ...
    margin: 0 0 10px;
        ...
        /*
         * CHECKBOX
         * Tidak menggunakan karakter Unicode seperti ✓
         * agar aman ketika di-render oleh Dompdf.
         */
        .check-box {
        ...
        /*
         * Membuat tanda centang menggunakan CSS.
         * Tidak bergantung pada font.
         */
        .check-box::after {
            content: "";
            position: absolute;
...
<body>
    ...
    <p>
        ...
        telah membaca dan memahami kebijakan privasi dari CV Surya Wijaya ("AHASS") dan
        memberikan persetujuan kepada AHASS, dan PT Daya Adicipta Motora ("Distributor") untuk :
    </p>
    ...
    <div class="item">
        ...
        <strong>2.</strong>
        Memperoleh, mengumpulkan, menyimpan, mengolah, memproses,
        menganalisa, mentransfer dan memusnahkan data pribadi untuk kegiatan promosi
        dan/atau informasi yang berkaitan dengan produk dan jasa kendaraan.
    </div>
    ...
    <p>
        ...
        (<span class="check-box"></span>) sesuai dengan kehendak saya pribadi
